...
interface Configuration
{
     ...
     *
     * @param null|string $config    The string contents to convert, i.e. 'one two three'.
     ...
     *
     * @param null|string $config  The string contents to convert, i.e. 'true'
     * @param null|bool   $default the default boolean value to return if a valid string wasn't provided
     */
