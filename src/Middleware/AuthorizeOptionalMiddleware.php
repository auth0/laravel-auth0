...
use Auth0\Laravel\Middleware\MiddlewareAbstract;
use Closure;
 ...
 * @api
 */
final class AuthorizeOptionalMiddleware extends MiddlewareAbstract implements AuthorizeOptionalMiddlewareContract
{
