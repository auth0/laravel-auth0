...
| ---------------------------------------------- | ------ | ---------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| [13.x](https://laravel.com/docs/13.x/releases) | 7.21+  | [8.3](https://www.php.net/releases/8.3/en.php) | Approx. [Feb 2028](https://laravel.com/docs/13.x/releases#support-policy) (EOL for Laravel 13)   |
